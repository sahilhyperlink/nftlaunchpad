...
contract LaunchNft is ERC721AUpgradeable, 
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721AUpgradeable,ERC1155ReceiverUpgradeable) returns (bool) {
